...
def generate_llama_4d_config(recompute_layers, num_layers=32, num_gpus=8, dp=2, cp=1, tp=2, pp=2, zero=True):
    if dp == 1:
        zero = False
...
if __name__ == '__main__':
    ...
    ds_parallel_config = generate_llama_4d_config(ast.literal_eval(args.recompute_layers), num_layers, args.num_gpus, args.dp, args.cp, args.tp, args.pp, args.zero)
