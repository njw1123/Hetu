...
void BatchMatMulTorch(const NDArray& a, bool trans_a, const NDArray& b,
  ...
  HT_LOG_TRACE << "execute torch batch matmul";
  at::bmm_out(output_tensor, a_tensor, b_tensor);
  HT_LOG_TRACE << "execute torch batch matmul done";
